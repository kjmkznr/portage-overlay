...
src_prepare() {
        epatch "${FILESDIR}/logwatch-manpage.patch"
        epatch "${FILESDIR}/logwatch-vsftpd.patch"
        epatch "${FILESDIR}/logwatch-dovecot.patch"
        epatch "${FILESDIR}/logwatch-named-dnssec.patch"
        epatch "${FILESDIR}/logwatch-secure.patch"
        epatch "${FILESDIR}/logwatch-smartd.patch"
        epatch "${FILESDIR}/logwatch-xntpd.patch"
}
...
src_install() {
	...
	newsbin scripts/logwatch.pl logwatch || die "dosbin logwatch failed"
	...
	newexe "${FILESDIR}"/logwatch.cron 00-logwatch
