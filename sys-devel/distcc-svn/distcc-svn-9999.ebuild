...
EAPI="2"
inherit eutils fdo-mime flag-o-matic multilib toolchain-funcs subversion autotools

DESCRIPTION="a program to distribute compilation of C code across several machines on a network(source from subversion repository)"
HOMEPAGE="http://distcc.org/"

ESVN_REPO_URI="http://distcc.googlecode.com/svn/trunk/"
...
src_prepare() {
	epatch "${FILESDIR}/${MY_PN}-3.0-xinetd.patch"
	# bug #253786
	epatch "${FILESDIR}/${MY_PN}-3.0-fix-fortify.patch"
	# Zeroconf Option http://code.google.com/p/distcc/issues/detail?id=59
	epatch "${FILESDIR}/distcc-zeroconf_options.patch"
